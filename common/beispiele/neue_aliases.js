...
const devices = [
  ...
  {
    source: "sonoff.0.Weihnachtsbaum.POWER",
    alias: "licht.weihnachtsbaum.on",
    role: "switch.light",
  },
  ...
  {
    source: "sonoff.0.AVR-Steckdose.ENERGY_Power",
    alias: "energie.avr.power",
    role: "value.power",
    unit: "W",
  },
  { source: "sonoff.0.TV-Steckdose.POWER", alias: "energie.tv.on", role: "switch" },
  {
    source: "sonoff.0.TV-Steckdose.ENERGY_Power",
    alias: "energie.tv.power",
    role: "value.power",
    unit: "W",
  },
