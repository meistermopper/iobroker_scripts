...
on({id: '0_userdata.0.Entprellen.Kühlung.Ventilator', change: "ne"}, async function (obj) {
    ...
    console.log(`Ventilator-Befehl ${targetState} vorgemerkt (500ms Entprellung aktiv)`);
});