...
on(
  { id: "0_userdata.0.Licht.Wohnzimmer.alle_Lampen", change: "ne" },
  async (obj) => {
    ...
    if (val === true || val === 1 || val === "true") {
      ...
      setStateDelayed(
        "alias.0.wohnzimmer.licht.fernsehlicht.POWER",
        true,
        200,
        true,
      );
      setStateDelayed(
        "alias.0.wohnzimmer.licht.Galaxie.POWER",
        true,
        400,
        true,
      ); // Zeitabstand leicht erhöht
      ...
      setStateDelayed(
        "alias.0.wohnzimmer.licht.wozilampe.on",
        false,
        600,
        true,
      );
