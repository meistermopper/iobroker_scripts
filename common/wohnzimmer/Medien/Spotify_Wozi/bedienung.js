...
const PLAYER_MAP = {
  "0_userdata.0.Entprellen.Medien.Player.Wohnzimmer.Spotify.next":
    "chromecast.0.cc_wozi.player.next",
  "0_userdata.0.Entprellen.Medien.Player.Wohnzimmer.Spotify.pause":
    "chromecast.0.cc_wozi.player.pause",
  "0_userdata.0.Entprellen.Medien.Player.Wohnzimmer.Spotify.play":
    "chromecast.0.cc_wozi.player.play",
  "0_userdata.0.Entprellen.Medien.Player.Wohnzimmer.Spotify.prev":
    "chromecast.0.cc_wozi.player.prev",
};
