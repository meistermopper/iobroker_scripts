...
async function Morgenprogramm(typ) {
  ...
  setState(
    "chromecast.0.Mini-Schlazi.player.url2play",
    "https://dispatcher.rndfnk.com/hr/hr1/live/mp3/high",
  );
    ...
    setTimeout(() => {
      ...
      timerMorgen.push(
        setTimeout(() => {
          ...
          timerMorgen.push(
            setTimeout(() => setState("chromecast.0.f0ef862c5b50.player.stop", true), 180000),
          );
        }, 1020000),
      );
    }, 180000),
  ...
  timerMorgen.push(
    setTimeout(() => {
      ...
      timerMorgen.push(
        setTimeout(() => setState("chromecast.0.d86c63581a19.player.stop", true), 2100000),
      );
    }, 1800000),
  );
}
