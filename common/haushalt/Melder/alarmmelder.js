...
const ALARM_SENSOREN = {
  "alias.0.vorkeller.serverschrank.smoke": {
    msg: "Rauch im Serverschrank!",
    icon: "🔥🔥🔥",
    type: "smoke",
  },
  ...
  "alias.0.kueche.geschirr.detected": {
    msg: "Wasser unterm Geschirrspüler!",
    icon: "🌊🌊🌊",
    type: "water",
  },
  "alias.0.kueche.boiler.detected": {
    msg: "Wasser unter der Spüle!",
    icon: "🌊🌊🌊",
    type: "water",
  },
};
...
// --- TRIGGER ---
console.log(
  `Gefahren-Melder: Überwachung von ${Object.keys(ALARM_SENSOREN).length} Sensoren gestartet.`,
);
