...
const RAEUME = {
    ...
    "Badezimmer_unten": { "Sensor_TEMP": 'alias.0.bad_unten.heizung.ACTUAL_TEMPERATURE', "Sensor_HUM": 'alias.0.bad_unten.heizung.HUMIDITY', "Aussensensor": "Aussen", "aliasName": "bad_unten", type: "heizung" },
    "Küche": { "Sensor_TEMP": 'alias.0.kueche.klima.temperature', "Sensor_HUM": 'alias.0.kueche.klima.humidity', "Aussensensor": "Aussen", "aliasName": "kueche", type: "klima" },
    "Büro": { "Sensor_TEMP": 'alias.0.buero.klima.temperature', "Sensor_HUM": 'alias.0.buero.klima.humidity', "Aussensensor": "Aussen", "aliasName": "buero", type: "klima" },
    "Konferenz": { "Sensor_TEMP": 'alias.0.konferenz.klima.temperature', "Sensor_HUM": 'alias.0.konferenz.klima.humidity', "Aussensensor": "Aussen", "aliasName": "konferenz", type: "klima" },
    "Badezimmer_oben": { "Sensor_TEMP": 'alias.0.bad_oben.klima.temperature', "Sensor_HUM": 'alias.0.bad_oben.klima.humidity', "Aussensensor": "Aussen", "aliasName": "bad_oben", type: "klima" },
    "Gäste_oben": { "Sensor_TEMP": 'alias.0.gast_oben.klima.temperature', "Sensor_HUM": 'alias.0.gast_oben.klima.humidity', "Aussensensor": "Aussen", "aliasName": "gast_oben", type: "klima" },
    "Gäste_unten": { "Sensor_TEMP": 'alias.0.gast_unten.klima.temperature', "Sensor_HUM": 'alias.0.gast_unten.klima.humidity', "Aussensensor": "Aussen", "aliasName": "gast_unten", type: "klima" },
    "Fitness": { "Sensor_TEMP": 'alias.0.fitness.klima.temperature', "Sensor_HUM": 'alias.0.fitness.klima.humidity', "Aussensensor": "Aussen", "aliasName": "fitness", type: "klima" },
    "Schlafzimmer": { "Sensor_TEMP": 'alias.0.schlafzimmer.klima.temperature', "Sensor_HUM": 'alias.0.schlafzimmer.klima.humidity', "Aussensensor": "Aussen", "aliasName": "schlafzimmer", type: "klima" },
    "Waschküche": { "Sensor_TEMP": 'alias.0.waschen.klima.temperature', "Sensor_HUM": 'alias.0.waschen.klima.humidity', "Aussensensor": "Aussen", "aliasName": "waschen", type: "klima" },
    ...
    if (empf && !offen && !gemeldet) {
        ...
        if (!doorCheckTimeouts[raum]) {
            doorCheckTimeouts[raum] = setTimeout(() => {
                if (getState(fID).val > 0 && !getState(`${PFAD}${RAUM_PFAD}${raum}.Lüftungsempfehlung`).val) {
                    let txt = `Im ${raum} sollte das Fenster geschlossen werden.`;
                    if (raum === "Wohnzimmer") txt = "Im Wohnzimmer sollte die Terrassentür geschlossen werden.";
                    notify(aDP, txt);
                }
