...
schedule("5 0 * * *", async () => {
    ...
    const std = Math.floor(tageslaengeMin / 60).toString().padStart(2, '0');
    ...
    const nStd = Math.floor(nachtlaengeMin / 60).toString().padStart(2, '0');
...
schedule("* * * * *", () => {
    ...
    if (restLichtMin > 0 && restLichtMin <= tageslaengeMin) {
        ...
        const h = Math.floor(restLichtMin / 60).toString().padStart(2, '0');
        ...
        const nh = Math.floor(restNachtMin / 60).toString().padStart(2, '0');
