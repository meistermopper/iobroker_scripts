//@liv-in-sky 2022  11.01.-10:00-  mit tasmota 10
 ...
 // das Standard html-Widget wird genutzt in der VIS - dazu den DP 0_userdata.0.Tabellen.SONOFFTabelleVIS.HTMLTableVis als binding angeben d.h.
 // im html-teil des widgets wird der daten punkt in geschweiften klammern angegeben z.B. {0_userdata.0.Tabellen.SONOFFTabelleVIS.HTMLTableVis}
 ...
 let   willUnterUserdataSpeichern=true;                  // die Tabelle wird unter 0_userdata.0.... gespeichert
 ...
 //ZUSÄTZLICH VARIABLEN
  let mitAlphabet=true;                                  // wenn true wird immer nach namen sortiertiert und eine zeile eingfügt mit dem Anfangsbuchstaben
 ...
 // let mitSearch=true;
  ...
  let deviceNameStattHostname=true;                        //zeigt devicename anstatt hostname
...
const htmlFeldUeber='Tasmota';                // für Überschrift und Signature falls htmlUberschrift und htmlSignature ist true
...
const nameSeitenLeiste="T A S M O T A"
...
async function needDP(){
    willUnterUserdataSpeichern ? welcherSpeicherOrt="0_userdata.0.Tabellen."+dpVIS : welcherSpeicherOrt="javascript." + instance + ".Tabellen@Liv."+dpVIS
