...
- **ioBroker Watchdog**:
  - Monitors adapters and reports failures after a waiting period, automatically filtering out instances with scheduled restarts or schedule mode (`adapter_off.js`).
