...
![Version](https://img.shields.io/badge/Version-1.2.4-success?style=flat-square)
...
- Update von licht_presence.js
- Update von radio_manuell.js
- Update von heos_offline.js
- Update von radio_auto.js
- Update von radio_manuell.js
- Update von playerstate.js
- Update von schranklicht.js
- Update von tv_licht.js
- Update von vu_reboot_standby.js
- Update von werte_schreiben_silvester.js
- Update von r2maeh2.js
- Update von serverschrank_taegl.js
- Update von weinklima_taegl.js
...
- Update von soh_change.js
- Update von solarprognose_master.js
- Update von stromausfall.js
- Update von astrozeiten.js
- Update von kalender.js
- Update von mond_zunehmend_abnehmend.js
- Update von weihnachtszeit.js
- Update von wochentage.js
- Update von zeiten.js
- Update von battery_states.js
- Update von raumwerte_lueften.js
- Update von sonoff_devices_table.js
- Update von sonoff_fail.js
- Update von tasmota_fw.js
- Update von vaillant_Neustart.js
- Update von domains_blocked.js
- Update von percent_blocking_both.js
- Update von proxmox_master_v2.js
- Update von iobroker_error.js
- Update von ram_monitor.js
- Update von versionen.js
- Update von dyndns_fail.js
- Update von failover_dyndns_master.js
- Update von network_version.js
- Update von neue_ip_failover.js
- Update von batterie_wechseln.js
- Update von hue_zigbee_states_restore.js
- Update von nut_client_inactive.js
- Update von usv_wartung_apc_server.js
- Update von usv_wartung_eaton_buero.js
- Update von device_not_available.js
- Update von termine_2T.js
- Update von abendlicht_TV_Wind_aus.js
- Update von autolicht_daemmer.js
- Update von baum_Zeitschalt.js
- Update von musiklicht.js
- Update von switch_abendlicht.js
- Update von switch_alle_lampen.js
- Update von switch_ventilatorlicht.js
- Update von ventilator_false.js
- Update von videolicht.js
- Update von clear_cache.js
- Update von fully_bewegung.js
- Update von fully_smart_laden.js
- Update von ladestation_neustart_hub.js
- Update von smartphones_laden.js
- Update von verbrauch_media.js
- Update von kachelofen_ventilator.js
- Update von switch_ventilator.js
