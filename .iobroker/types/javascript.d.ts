...
declare global {
  namespace iobJS {
    ...
    type ObjectChangeHandler = (
      id: string,
      obj: iobJS.Object | null | undefined,
    ) => void | Promise<void>;
    type OriginalStateChangeHandler = (
      id: string,
      obj: State | null | undefined,
    ) => void | Promise<void>;
    ...
    type GetEnumCallback = (
      err?: Error | null,
      enums?: Record<string, EnumObject>,
    ...
    type ChownFileCallback = (
      err?: NodeJS.ErrnoException | null,
      processed?: ChownFileResult[],
    ) => void;
    ...
    type GetObjectViewPromise<T extends AnyObject> = Promise<
      NonNullCallbackReturnTypeOf<GetObjectViewCallback<T>>
    >;
    ...
    type GetObjectListPromise = Promise<
      NonNullCallbackReturnTypeOf<GetObjectListCallback<iobJS.Object>>
    >;
    ...
    type InferGetObjectViewItemType<
    ...
    interface QueryResult extends Iterable<string> {
      ...
      getState<T extends iobJS.StateValue = any>():
        | TypedState<T>
        | iobJS.AbsentState
        | null
        | undefined;
  ...
  function getEnums(
    enumName?: string,
  ): { id: string; members: string[]; name: iobJS.StringOrTranslated }[];
